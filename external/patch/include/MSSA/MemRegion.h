...
public:
    ...
    inline ModRefInfo getModRefInfo(const CallInst *call, const CallInst *otherCall) {
        return getModRefInfo(SVFUtil::getLLVMCallSite(call), SVFUtil::getLLVMCallSite(otherCall));
    }
