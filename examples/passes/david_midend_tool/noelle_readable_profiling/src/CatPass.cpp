...
namespace {
  ...
  struct CAT : public ModulePass {
    ...
    bool runOnModule (Module &M) override {
      ...
      for (auto& bb : F){
        for (auto &inst : bb){
          errs() << F.getName() << " Instruction: \"" << inst << "\": Self|Total  = " << hot->getSelfInstructions(&inst) << "|" << hot->getTotalInstructions(&inst) << "\n";
//          errs() << "Instruction: \"" << inst << "\": Total = " << hot->getTotalInstructions(&inst) << "\n";
	...
	*/
      ...
      for (auto& bb : *mainF){
        for (auto &inst : bb){
          errs() << mainF->getName() << " Instruction: \"" << inst << "\": Self|Total  = " << hot->getSelfInstructions(&inst) << "|" << hot->getTotalInstructions(&inst) << "\n";
//          errs() << "Instruction: \"" << inst << "\": Total = " << hot->getTotalInstructions(&inst) << "\n";
