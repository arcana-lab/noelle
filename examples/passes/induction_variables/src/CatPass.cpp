...
struct CAT : public ModulePass {
  ...
  bool runOnModule(Module &M) override {
    ...
    errs() << " This loop has " << hottestLoopNode->getNumberOfSubLoops()
    ...
    /*
     * Generate the code to compute the total number of iterations for the
     * current loop invocation.
     */
