...
define i32 @main() #3 {
  %1 = tail call noalias i8* @malloc(i64 16) #8
  %2 = bitcast i8* %1 to %struct._N*
  tail call void @_Z10appendNodeP2_Nii(%struct._N* %2, i32 42, i32 99)
  br label %3

; <label>:3:                                      ; preds = %5, %0
  %.0 = phi %struct._N* [ %2, %0 ], [ %11, %5 ]
  %4 = icmp eq %struct._N* %.0, null
  br i1 %4, label %12, label %5

; <label>:5:                                      ; preds = %3
  %6 = getelementptr inbounds %struct._N, %struct._N* %.0, i64 0, i32 0
  %7 = load i32, i32* %6, align 8
  %8 = tail call i32 @_Z16heavyComputationi(i32 %7)
  %9 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 %8)
  %10 = getelementptr inbounds %struct._N, %struct._N* %.0, i64 0, i32 1
  %11 = load %struct._N*, %struct._N** %10, align 8
  br label %3
