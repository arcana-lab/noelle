...
static void matmul_sub(double ablock[5][5],
                       double bblock[5][5],
                       double cblock[5][5]);
        ...
        for (m = 0; m < 5; m++) {
          for (i = 1 * 3; i <= grid_points[0] - 3 * 1 - 1; i++) {
            forcing[i][j][k][m] =
                forcing[i][j][k][m]
                - dssp
                      * (ue[i - 2][m] - 4.0 * ue[i - 1][m] + 6.0 * ue[i][m]
                         - 4.0 * ue[i + 1][m] + ue[i + 2][m]);
          }
        }
        ...
        for (m = 0; m < 5; m++) {
          for (j = 1 * 3; j <= grid_points[1] - 3 * 1 - 1; j++) {
            forcing[i][j][k][m] =
                forcing[i][j][k][m]
                - dssp
                      * (ue[j - 2][m] - 4.0 * ue[j - 1][m] + 6.0 * ue[j][m]
                         - 4.0 * ue[j + 1][m] + ue[j + 2][m]);
          }
        }
        ...
        for (m = 0; m < 5; m++) {
          for (k = 1 * 3; k <= grid_points[2] - 3 * 1 - 1; k++) {
            forcing[i][j][k][m] =
                forcing[i][j][k][m]
                - dssp
                      * (ue[k - 2][m] - 4.0 * ue[k - 1][m] + 6.0 * ue[k][m]
                         - 4.0 * ue[k + 1][m] + ue[k + 2][m]);
          }
        }
        ...
        rhs[i][j][k][4] =
            ...
            - tx2
                  * ((c1 * u[i + 1][j][k][4] - c2 * square[i + 1][j][k]) * up1
                     - (c1 * u[i - 1][j][k][4] - c2 * square[i - 1][j][k])
                           * um1);
      }
    }
  }
    ...
    for (j = 1; j < grid_points[1] - 1; j++) {
      for (k = 1; k < grid_points[2] - 1; k++) {
        ...
        rhs[i][j][k][2] =
            ...
            - ty2
                  * (u[i][j + 1][k][2] * vp1 - u[i][j - 1][k][2] * vm1
        ...
        rhs[i][j][k][4] =
            ...
            - ty2
                  * ((c1 * u[i][j + 1][k][4] - c2 * square[i][j + 1][k]) * vp1
                     - (c1 * u[i][j - 1][k][4] - c2 * square[i][j - 1][k])
                           * vm1);
      }
    }
  }
    ...
    for (j = 1; j < grid_points[1] - 1; j++) {
      for (k = 1; k < grid_points[2] - 1; k++) {
        ...
        rhs[i][j][k][3] =
            ...
            - tz2
                  * (u[i][j][k + 1][3] * wp1 - u[i][j][k - 1][3] * wm1
        ...
        rhs[i][j][k][4] =
            ...
            - tz2
                  * ((c1 * u[i][j][k + 1][4] - c2 * square[i][j][k + 1]) * wp1
                     - (c1 * u[i][j][k - 1][4] - c2 * square[i][j][k - 1])
                           * wm1);
      }
    }
  }
